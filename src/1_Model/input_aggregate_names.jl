...
state_names = [
    "A", "Z", "ZI", "RB" , "μ", "μw", "σ", "Ylag","qBlag","Btarget", "Bgov", "Bgovlag","KG",
     "Tlag", "Ilag", "wlag", "qlag", "Clag", "av_tax_ratelag", "τproglag",
    "Glag", "Glag2","Gshock","Gshock2", "Tprogshock", "Rshock", "Sshock"
]

# List cross-sectional controls / distributional summary variables (no equations in aggregate model expected)
distr_names   = ["GiniC", "TOP10Ishare", "TOP10Inetshare", "TOP10Wshare", "sdlogy"]

control_names = [
    "r", "w", "K", "π" ,"πw", "Y" ,"C", "q",  "N", "mc", "mcw", "u","rRB", "qB", "bankprofits","tauLS",
